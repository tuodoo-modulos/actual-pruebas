...
class PagoSimplificadoBanorte:
    ...
    def generar_pagos(self):
        ...
        for pago in pagos:
            linea = PagoSimplificadoLineaBanorte()
            ...
            linea.fecha_aplicacion = self.wizard.fecha_de_aplicacion
...
class PagoSimplificadoLineaBanorte:
    operacion = None
    clave_id = None
    cuenta_origen = None
